...
> [!IMPORTANT]
> This experimental collaborator branch pins the matching
> [GEAK Codex runtime](https://github.com/AranKomat/GEAK/tree/codex-workflow-runtime-poc),
...
| Backend | Claude; Codex for GEAK role agents |
